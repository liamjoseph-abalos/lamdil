...
Shadow Realm 2 is a room. "You see Ethiram standing, waiting for you."
...
Understand "Mobilorus" as casting xyzzyz.
...
After spinning the closed Safe to 8318: now the Safe is open; say "After spinning in all four numbers in, a portal materializes behind you. 'Go through it,' a voice in your head that vaguely sounds like Ethiram whispers.";
	...
	now Portal is open.
Portal is a secret door. Portal is above Abandoned Cages and below Edge of Shadows. 
...
Every turn during the Cannibal Fight:
	...
	if the Cannibal is dead:
		now the player is docile;
		now the player is notHit;
		now the left hand status line is "Cannibal: Deceased";
		now the Cannibal is nowhere.
Cannibal Fight ends when the Cannibal is dead.	
When Cannibal Fight ends:
	now the player is docile;
	now the player is notHit;
	now the left hand status line is "";
	say "With the last swing of your weapon, the Cannibal is vanquished. He beings to shrink down to his normal size, and he curls up into a ball. You wonder about the spirit that left his body. As you approach him, you can hear a faint whisper directed towards you. 'Ethiram...' he coughs up blood. At the sound of Ethiram's name you hurry to his nearly lifeless body. '...is not what he seems...' he clutches his chest. '...be careful...there are more...' with a final breath, the Cannibal, or at least his body, expires.";
...
F18 is a room. F18 is northwest of F14.
