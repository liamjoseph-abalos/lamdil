...
When Shadow Finale begins:
	...
	wait for any key;
	say "'...but he didn't get me. Some prisoners and I made a break for it. We found a way out of the prisoner and we ran. We ran as far as our legs would take us. And we discovered, The Jungle. I need you to get to The Jungle. I'm trapped here, but with your help, you can get me out, and in turn, I'll take you back to your home.
	wait for any key'";
	wait for any key;
	...
	wait for any key;
	say "'Say 'xyzzy' and you will be back in the prison. Good luck.' Ethiram blinks out of existence and you're left alone in the shadows.".
...
The Guard's Quarters is west of the Captain's Staircase. The Guard's Quarters is a dark room. "You enter what appears to be the room where the Guard's of the prisoner sleep. By each bed is a chest full of belongings. Each chest is chained and locked shut, except for one. ".
In the Guard's Quarters is an openable container called Chest. Chest is closed. The Chest is fixed in place. "[if open]The chest is open and nothing of importance remains.[else]You see one chest, in the corner of the room hidden from the light, might be able to open if you pry enough." In Chest is a thing called Iron Key. In Chest is a thing called Stale Bread. In Chest is a thing called Guard's Satchel.
Rule for printing the name of Guard's Chest: 
	say "[printed name of Guard's Chest]";
	omit contents in listing.
	
The Iron Door is east of the Captain's Staircase and west of the Armoury. The Iron Door is a door. The Iron Door is scenery. The Iron Door is locked. Iron Key unlocks the Iron Door. The Armoury is a dark room. "As you enter the room, the light from your torch reveals an armoury. However, little remains. You think to yourself that it was all taken in Ethiram's skirmish. Scrawled across the floor is a broken sowrd and a helmet." In the Armoury is Broken Sword and Guard's Helmet.
...
Instead of listening to Warden's Staircase:
	if Warden is not dead:
		say "Above you hear heavy thuds and metal scraping across stone. You gulp. 'This is it' you think to yourself. You take a deep breath.";
	otherwise:
		say "You hear nothing unexpected.".

Part 4 - Warden's Chapter

The Warden's Staircase is below the Warden's Room. Above the Warden's Staircase is a dark room called the Warden's Room. The Warden is a man in the Warden's Room.
...
When Warden Introduction begins:
	say "Climbing up the staircase, you see a man in full metal armour waiting for you.";
	wait for any key;
...
[I, along with many others, lived in the prison for decades. Just like you, we all awoke one day within the cold walls. But at least there were people around to explain what was going on. Everything ran smoothly, it was only until our previous warden mysteriously vanished that things turned sour. The new warden immediately called for all current prisoners to be executed. To tell it short, there was a revolt, and nearly all of the prisoners perished. It was only a few of us that had managed to escape amongst the chaos. We had no idea where we were when we escaped, but what we did find was what we thought was a temple dedicated to Godly Beings. Upon further inspection, it was a basement that kept the high profile prisoners away from the rest of us. It appeared as if they had began to consume each other and fought each other. There were 9 cages, but only 8 bodies. The bodies, or the remains from the bodies, were arranged in some type of circle with an enscription carved onto the floor. One of us read the enscription out loud and the bodies began to float into the air and encircle each and everyone one of us. The letter carved into the floor floated upwards and began to shine. After a brief moment, everything turned quiet. Then it turned white. And when the dust settled, everyone was gone. I was alone. But I wasn't the same. It was as if I was... ethereal. And then you came. Since then I've been trying my best to guide you off the prisoner and to where I am. I think with your help you and I can escape whatever this hell hole is. Speak these words and you'll be sent back, and with it, the power to absorb the souls of those you slain. There will be struggles ahead, and you will need all the help you can get. 'xyzzy']
