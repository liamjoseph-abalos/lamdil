...
Include version 15/170131 of Flexible Windows by Jon Ingold. [See documentation about where to find this version.]
...
The sidebar can be prompted automatically, shown automatically, or shown manually (this is the sidebar introduction method). The sidebar is shown automatically.
...
"Look (L)"
"Inventory (I)"
"Take/Drop (something)"	266.	"Take/Drop something"
"Examine (X)/Read (something)"	267.	"Examine (X) it"
"Open/Close (something)"	268.	"Open/Close it"
"Push/Pull (something)"	269.	"Push/Pull it"
"Eat (something)"	270.	"Eat something"
"Break (something)"	271.	"Break something"
"Attack (a)"	272.	"Attack something"
"Equip (eq) (something)"	273.	"Equip something"
"Unequip (un) (something)"	274.	"Block"
"Block (b)"	275.	"Dodge"
"Dodge (do)"	276.	"Parry"
"Parry (p)"
"Wait (Z)"
...
The sidebar can be either auto-adjusting the status bar or leaving the status bar alone. The sidebar is leaving the status bar alone.
