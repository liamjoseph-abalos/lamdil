...
Every turn during the Treacherous Unlock: 
	if the fpoints of the player is 3:
		say "All three fiery marks on your arm begin to grow brighter, and brighter, as it shoots a powerful pillar of fire straight into the sky.";		
		wait for any key;
...
Treacherous Unlock ends when the player is in Descent Into the Abyss. 
...
Every turn during the Underworld Unlock:
	if the specPoints of the player is 3:
		say "All three spectral marks on your arm begin to grow brighter, and brighter, as it shoots a powerful pillar of otherworldy energy straight into the sky.";
		wait for any key;
...
Underworld Unlock ends when the player is in Edge of Shadows.

Chaos Unlock is a scene.
Chaos Unlock begins when the player is in Edge of Shadows.
Every turn during the Chaos Unlock:
	if the bloodPoints of the player is 3:
		say "All three bloody marks on your arm begin to grow darker, and darker shades of red, as it shoots a powerful bloody pillar of energy straight into the sky.";
		wait for any key;
...
Chaos Unlock ends when the player is in Descent Into the Abyss. 
