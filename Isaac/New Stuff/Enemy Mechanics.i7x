...
Setting action variables for an actor hitting:
	if the actor is Mutated Prisoner:
		...
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 14 and 16 minus x.
...
Setting action variables for an actor hitting:
	if the actor is Living Statue:
		...
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 34 and 46 minus x.
...
Setting action variables for an actor hitting:
	if the actor is Reinforced Guard:
		...
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 26 and 34 minus x.
...
Setting action variables for an actor hitting:
	if the actor is Overseer:
		...
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 27 and 35 minus x.
...
Setting action variables for an actor hitting:
	if the actor is Corrupted Entity:
		...
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 50 and 50 minus x.
