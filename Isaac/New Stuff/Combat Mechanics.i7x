...
Setting action variables for an actor hitting:
	if the actor is the player:
		if the player is wearing Treacherous Zweihander: 
			now the damage inflicted is a random number between 25 and 50; [avg dmg 36; deviation 12]
			if the noun is not the player:
				now the noun is hostile.
Report the player hitting something:
	if the player is wearing Treacherous Zweihander:
...
Spiked Mace is a weapon. The current turns of the Spiked Mace is 1. The wepParry of the Spiked Mace is -2. The wepRiposte of the Spiked Mace is 58. The wepDodge of the Spiked Mace is -2. The wepReduction of the Spiked Mace is 7.
Setting action variables for an actor hitting:
	if the actor is the player: 
...
Report the player hitting something:
	if the player is wearing Chaos Maul:
		if the current turns of the Spiked Mace is 0:
			say "You raise the Spiked Mace over your head." instead;
		if the current turns of the Spiked Mace is 1:
			say "You crash the Spiked Mace down upon [the noun], dealing [damage inflicted] point[s] of damage!" instead.
Carry out the player hitting something:
	if the player is wearing Chaos Maul:
		if the current turns of the Spiked Mace is 1:
...
Chaos Maul  is a weapon. The current turns of the Chaos Maul  is 1. The wepParry of the Chaos Maul  is -3. The wepRiposte of the Chaos Maul  is 83. The wepDodge of the Chaos Maul  is -3. The wepReduction of the Chaos Maul  is 9.
Setting action variables for an actor hitting:
	if the actor is the player: 
		if the player is wearing Chaos Maul : 
...
Report the player hitting something:
	if the player is wearing Chaos Maul :
		if the current turns of the Chaos Maul  is 0:
			say "You swing the Chaos Maul  behind you." instead;
		if the current turns of the Chaos Maul  is 1:
			say "You brutalize [the noun] with the Chaos Maul , dealing [damage inflicted] point[s] of damage!" instead.
Carry out the player hitting something:
	if the player is wearing Chaos Maul :
		if the current turns of the Chaos Maul  is 1:
