...
Spectral Fight 1 ends when the time of day is 3:01 AM.
When Spectral Fight 1 ends:
	now the player is docile;
	now the player is notHit;
	now the left hand status line is "";
	now the time of day is 10:00 AM;
	say "Your body absorbs the otherwordly energy of the Apparition as a spectral mark begins to form on your body.";
	wait for any key;
	increase the specPoints of the player by 1;
	say "The energy settles as it leaves a strange marking on your arm.".
...
Setting action variables for an actor hitting:
	if the actor is Spectral Apparition 1:
		...
		otherwise:
			...
			now the damage inflicted is a random number between 41 and 51 minus x.
...
When Fiery Fight 1 ends: 
	...
	now the left hand status line is "";
	now the time of day is 10:00 AM;
	say "Your body absorbs the fiery power of the Apparition, as a mark of fire ignites onto your body.";
	wait for any key;
...
Every turn during Bloody Fight 1: 
	...
	if the Bloody Apparition 1 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 1 ends when the time of day is 3:01 AM.
When Bloody Fight 1 ends:
	now the player is docile;
	now the player is notHit;
	now the left hand status line is "";
	now the time of day is 10:00 AM;
	say "The blood of the apparition transfuses with your body as its energy seeps into soul.";
	wait for any key;
	increase the bloodPoints of the player by 1;
	say "The blood settles leaving a clean, distinguishable red mark on your arm.".
...
Every turn during Spectral Fight 2: 
	...
	if the Spectral Apparition 2 is dead:
		...
		now the time of day is 3:00 AM.
Spectral Fight 2 ends when the time of day is 3:01 AM.
...
Every turn during Fiery Fight 2: 
	...
	if the Fiery Apparition 2 is dead:
		...
		now the time of day is 3:00 AM.
Fiery Fight 2 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 2: 
	...
	if the Bloody Apparition 2 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 2 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 3: 
	...
	if the Bloody Apparition 3 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 3 ends when the time of day is 3:01 AM.
...
Every turn during Fiery Fight 3: 
	...
	if the Fiery Apparition 3 is dead:
		...
		now the time of day is 3:00 AM.
Fiery Fight 3 ends when the time of day is 3:01 AM.
...
Every turn during Spectral Fight 3: 
	...
	if the Spectral Apparition 3 is dead:
		...
		now the time of day is 3:00 AM.
Spectral Fight 3 ends when the time of day is 3:01 AM.
...
Every turn during Spectral Fight 4: 
	...
	if the Spectral Apparition 4 is dead:
		...
		now the time of day is 3:00 AM.
Spectral Fight 4 ends when the time of day is 3:01 AM.
...
Every turn during Fiery Fight 4: 
	...
	if the Fiery Apparition 4 is dead:
		...
		now the time of day is 3:00 AM.
Fiery Fight 4 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 4: 
	...
	if the Bloody Apparition 4 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 4 ends when the time of day is 3:01 AM.
...
Every turn during Fiery Fight 5: 
	...
	if the Fiery Apparition 5 is dead:
		...
		now the time of day is 3:00 AM.
Fiery Fight 5 ends when the time of day is 3:01 AM.
...
Every turn during Spectral Fight 5: 
	...
	if the Spectral Apparition 5 is dead:
		...
		now the Spectral Apparition 4 is nowhere;
		now the time of day is 3:00 AM.
Spectral Fight 5 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 5: 
	...
	if the Bloody Apparition 5 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 5 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 6: 
	...
	if the Bloody Apparition 6 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 6 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 7: 
	...
	if the Bloody Apparition 7 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 7 ends when the time of day is 3:01 AM.
...
Every turn during Fiery Fight 6: 
	...
	if the Fiery Apparition 6 is dead:
		...
		now the time of day is 3:00 AM.
Fiery Fight 6 ends when the time of day is 3:01 AM.
...
Every turn during Spectral Fight 6: 
	...
	if the Spectral Apparition 6 is dead:
		...
		now the time of day is 3:00 AM.
Spectral Fight 6 ends when the time of day is 3:01 AM.
...
Every turn during Fiery Fight 7: 
	...
	if the Fiery Apparition 7 is dead:
		...
		now the time of day is 3:00 AM.
Fiery Fight 7 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 8: 
	...
	if the Bloody Apparition 8 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 8 ends when the time of day is 3:01 AM.
...
Every turn during Bloody Fight 9: 
	...
	if the Bloody Apparition 9 is dead:
		...
		now the time of day is 3:00 AM.
Bloody Fight 9 ends when the time of day is 3:01 AM.
