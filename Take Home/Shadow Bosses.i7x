...
The current hit points of the Cannibal is 250. The maximum hit points of the Cannibal is 250.
...
Setting action variables for an actor hitting:
	if the actor is Cannibal:
		if the blockTrue of the player is 0:
			now the damage inflicted is a random number between 20 and 38 minus the damageReduction of the player;
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 20 and 38 minus x.
...
Carry out Cannibal hitting the player:
	...
	if the current turns of the Vicious Claws is 2:
		now the player is hit;
		if the blockTrue of the player is 0:
			now the damage inflicted is a random number between 24 and 43 minus the damageReduction of the player;
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 24 and 43 minus x;
		if dodgeTrue of the player is 1:
			do nothing;
		otherwise if parryTrue of the player is 1:
			decrease the current hit points of the Cannibal by the riposteDamage of the player;
	...
	if the current turns of the Vicious Claws is 1:
		...
		if the blockTrue of the player is 0:
			now the damage inflicted is a random number between 30 and 47 minus the damageReduction of the player;
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 30 and 47 minus x;
		if dodgeTrue of the player is 1:
			do nothing;
		otherwise if parryTrue of the player is 1:
			decrease the current hit points of the Cannibal by the riposteDamage of the player;
...
The current hit points of the Cutthroat is 175. The maximum hit points of the Cutthroat is 175.
...
Setting action variables for an actor hitting:
	if the actor is Cutthroat:
		if the blockTrue of the player is 0:
			now the damage inflicted is a random number between 35 and 40 minus the damageReduction of the player;
		otherwise:
			let x be the damageReduction of the player plus the damagePrevented of the player;
			now the damage inflicted is a random number between 35 and 40 minus x.
...
The current hit points of the Mercenary is 175. The maximum hit points of the Mercenary is 175.
